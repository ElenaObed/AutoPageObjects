...
public class TransferPage {
    ...
    private final SelenideElement errorMes = $("[data-test-id=error-notification]");
    ...
    public void findError (String expectedText){
        errorMes.shouldHave(exactText(expectedText), Duration.ofSeconds(15)).shouldBe(Condition.visible);
    }
}
